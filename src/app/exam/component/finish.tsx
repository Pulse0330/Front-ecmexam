...
// ─────────────────────────────────────────────
const FinishExamResultDialog = forwardRef<FinishExamDialogHandle, FinishExamResultDialogProps>(
	(
		{
			examType,
			answeredCount,
					...
					<div className="space-y-3 sm:space-y-4 py-3 sm:py-4">
						<div className="bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-xl p-3 sm:p-4 border-2 border-blue-200 dark:border-blue-800 shadow-inner">
							...
							<div className="space-y-2">
								...
								<Progress value={progressPercentage} className="h-2 sm:h-3 shadow-inner" />
							</div>
						</div>
