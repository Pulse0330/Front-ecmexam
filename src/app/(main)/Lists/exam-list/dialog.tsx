      ...
      <DialogContent className="w-full max-w-4xl p-0 flex flex-col max-h-[95vh] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2.5">
              {(isMobile ? mobileMonitoringRules : desktopMonitoringRules).map(
                (rule, idx) => (
                  <RuleItem key={`monitoring-${idx}`} {...rule} />
                )
              )}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2.5">
              {systemRestrictions.map((rule, idx) => (
                <RuleItem key={`system-${idx}`} {...rule} />
              ))}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2.5">
              {behavioralRules.map((rule, idx) => (
                <RuleItem key={`behavioral-${idx}`} {...rule} />
              ))}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2.5">
              {examGuidelines.map((rule, idx) => (
                <RuleItem key={`guideline-${idx}`} {...rule} />
              ))}
            </div>
          </div>
        </div>
