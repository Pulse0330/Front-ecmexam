...
export const SorilCard: React.FC<SorilCardProps> = ({ exam }) => {
	...
	// Сорил эхлүүлэх үйлдэл
	const handleClick = () => {
		console.log("Сорил эхлүүлэх:", exam.exam_id);
		...
		<Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group border-border">
			...
			<div className="relative h-48 overflow-hidden bg-muted">
				...
				<div className="absolute top-3 right-3 flex flex-col gap-2">
					{isCompleted && (
						<Badge className="bg-chart-2 hover:bg-chart-2/90 shadow-lg border-0">
