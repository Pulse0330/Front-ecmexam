									...
									<CardContent className="p-4 relative">
										...
										<div className="relative flex items-center gap-3">
											...
											<div className="flex-1 min-w-0">
												...
												<div className="text-xs opacity-90">Дууссан сорил</div>
											</div>
										</div>
									</CardContent>
								</Card>
									...
									<CardContent className="p-4 relative">
										...
										<div className="relative flex items-center gap-3">
											...
											<div className="flex-1 min-w-0">
												...
												<div className="text-xs opacity-90">Дундаж үр дүн</div>
											</div>
										</div>
									</CardContent>
								</Card>
									...
									<CardContent className="p-4 relative">
										...
										<div className="relative flex items-center gap-3">
											...
											<div className="flex-1 min-w-0">
												...
												<div className="text-xs opacity-90">Хамгийн өндөр</div>
											</div>
										</div>
									</CardContent>
								</Card>
								...
								<div className="flex items-center justify-between">
									<div className="flex items-center gap-4">
										<h2 className="text-2xl md:text-3xl font-bold bg-linear-to-r from-primary to-primary/70 bg-clip-text text-transparent">
											{selectedLessonId === 0
												? "Бүх сорилууд"
												: `${lessons.find((l) => l.lesson_id === selectedLessonId)?.lesson_name || ""} - Сорилууд`}
										</h2>
									</div>
							...
							<CardContent className="p-6 space-y-5">
								...
								{exams.length > 0 && (
									<div className="relative">
										...
										<input
											type="text"
											placeholder="Сорилын нэр эсвэл хичээлээр хайх..."
											value={searchQuery}
									...
									<div className="flex flex-col items-center justify-center py-16 text-center">
										...
										<p className="text-sm text-muted-foreground max-w-sm">
											{hasApiError
												...
												: searchQuery
													? `"${searchQuery}" хайлтад тохирох сорил олдсонгүй. Өөр нэрээр хайж үзнэ үү.`
													: selectedLessonId === 0
														? "Танд одоогоор сорилын үр дүн байхгүй байна."
														: `${lessons.find((l) => l.lesson_id === selectedLessonId)?.lesson_name || "Энэ хичээл"}-д сорилын үр дүн байхгүй байна.`}
										</p>
									</div>
								)}
							</CardContent>
