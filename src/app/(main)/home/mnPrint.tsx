    ...
    >
      ...
      <div style={{ padding: "14px 22px", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "10px" }}>
          ...
          <h2 style={{ fontSize: "13px", fontWeight: 600, margin: "3px 0 0 0", color: "#333" }}>
        ...
        <div style={{ display: "flex", gap: "14px", marginBottom: "14px" }}>
          ...
          >
            {imgSrc ? (
              ...
              <div style={{ fontSize: "10px", fontWeight: 700, textAlign: "center", color: "#1a3a6b", lineHeight: 1.5 }}>
            ...
            <tbody>
              {[
                ...
                <tr key={idx} style={{ borderBottom: "1px solid #e5e7eb" }}>
                  <td style={{ padding: "2.5px 8px 2.5px 0", color: "#555", textAlign: "right", whiteSpace: "nowrap", width: "46%" }}>
                    {label}
                  </td>
                  <td style={{ padding: "2.5px 0 2.5px 8px", fontWeight: 500, color: "#111" }}>
                    {value}
                  </td>
                </tr>
              ))}
        ...
        {/* Хуваарийн гарчиг */}
        <p style={{ fontSize: "11px", fontStyle: "italic", fontWeight: 700, margin: "0 0 5px 0" }}>
          Таны сонгосон хичээлүүд, суудлын хуваарь, шалгалтад ирэх хугацаа, орох хэсэг
        </p>

        {/* Хуваарийн хүснэгт */}
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "10.5px", border: "1px solid #bbb", marginBottom: "14px" }}>
          <thead>
            <tr style={{ background: "#f3f4f6" }}>
              {["№", "Хичээл", "Шалгалтын төв", "Заал", "Суудал", "Огноо", "Эхлэх цаг", "Дуусах цаг"].map((h) => (
                <th key={h} style={{ padding: "4px 5px", border: "1px solid #bbb", fontWeight: 600, textAlign: "center", whiteSpace: "nowrap" }}>
                  {h}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            <tr>
              <td style={{ padding: "4px 5px", border: "1px solid #bbb", textAlign: "center" }}>1.</td>
              <td style={{ padding: "4px 5px", border: "1px solid #bbb" }}>{item.name}</td>
              <td style={{ padding: "4px 5px", border: "1px solid #bbb" }}>{item.roomname}</td>
              <td style={{ padding: "4px 5px", border: "1px solid #bbb", textAlign: "center" }}>{item.room_number}</td>
              <td style={{ padding: "4px 5px", border: "1px solid #bbb", textAlign: "center" }}>{item.seat_number}</td>
              <td style={{ padding: "4px 5px", border: "1px solid #bbb", textAlign: "center", whiteSpace: "nowrap" }}>
    ...
    {item.end_date.replace("T", " ").slice(11, 16)}
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "14px" }}>
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "10px", fontWeight: 700, marginTop: "4px", letterSpacing: "2px" }}>
        ...
        <div style={{ fontSize: "10.5px" }}>
          ...
          <ul style={{ margin: 0, paddingLeft: "16px", lineHeight: "1.85", color: "#222" }}>
            <li>Шалгуулагч нь суудлын хуваарийн дагуу ирж шалгалтад орно.</li>
            <li>Суудлын хуваарьт заасан хугацаанаас өмнө ирэх шаардлагагүй бөгөөд хоцорсон тохиолдолд шалгалтад оруулахгүй байхыг анхаарна уу.</li>
            <li>Шалгалтын байранд ирэх цагийн хуваарийн дагуу ирж өөрийн заасан орох хэсгээр нэвтрэнэ.</li>
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      for (let i = 0; i < printList.length; i++) {
        ...
        const el = document.getElementById(`mn-print-${item.examinee_number}-${i}`);
