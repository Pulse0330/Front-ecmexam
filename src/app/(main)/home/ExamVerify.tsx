...
export function ExamVerifyDialog({
  ...
  const [selectedEsisRoomID, setSelectedEsisRoomID] = useState<number | null>(null);
  ...
  return (
    <>
      ...
      <AlertDialog open={isConfirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Та бүртгэхдээ итгэлтэй байна уу?</AlertDialogTitle>
            <AlertDialogDescription>
              Сонгосон өрөө болон хуваарьт шалгалтанд бүртгүүлэхийг баталгаажуулна уу.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
