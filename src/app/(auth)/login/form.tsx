			...
			if (group === 3 || group === 4) {
				...
				if (userData.is_enabled === 0) {
					toast.info("Профайл мэдээллээ бөглөнө үү", {
						description:
							"Та профайл мэдээллээ бүрэн бөглөсний дараа системд нэвтрэх боломжтой болно.ЕСМ ГРУПП ",
						duration: 5000,
					});
			...
			<Dialog open={announcementOpen} onOpenChange={setAnnouncementOpen}>
				<DialogContent className="sm:max-w-md bg-white dark:bg-gray-900 border-0 shadow-2xl p-0 overflow-hidden">
					...
					<div className=" px-6 py-5 flex items-start gap-3">
						...
						<div>
							<DialogTitle className="text-amber-950 font-bold text-lg leading-tight">
								Бүртгэл түр зогссон тухай мэдэгдэл
							</DialogTitle>
					...
					<div className="px-6 py-5 space-y-4">
						<p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
							...
							авах болсонтой холбогдуулан{" "}
							<span className="text-red-600 dark:text-red-400 font-semibold">
								шалгуулагчийн бүртгэлийг түр зогсоож байна.
							</span>
						</p>

						<div className="rounded-xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/50 px-4 py-3">
